...
const SOCIALS = [
  {
    label: 'GitHub',
    href:  'https://github.com/gabriel07-gif',
    icon: (
  ...
  {
    label: 'LinkedIn',
    href:  'https://www.linkedin.com/in/gabriel-lucas-439153308/',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  {
    label: 'Instagram',
    href:  'https://instagram.com/devgabriel_01',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
...
const STACK = ['Next.js', 'TypeScript', 'Framer Motion', 'Three.js'];
      ...
      <div className="footer-inner">
        ...
        <div className="footer-stack" aria-label="Stack usada">
          ...
          <div className="footer-stack-pills">
            {STACK.map(s => (
              <span key={s} className="footer-pill">{s}</span>
            ))}
          </div>
        </div>
        ...
        {/* Back to top */}
        <a href="#inicio" className="footer-top" aria-label="Voltar ao topo">
          {t('footer.top')}
        </a>
      </div>
